...
/*                                OCaml                                  */
/*                                                                       */
/*         Damien Doligez, projet Gallium, INRIA Paris                   */
...
void is_key_unset(const char* test, value eph) {
  is_false(test, "key unset", caml_ephemeron_get_key(eph, 0, NULL));
}

void is_data_unset(const char* test, value eph) {
  is_false(test, "data unset", caml_ephemeron_get_data(eph, NULL));
}
...
CAMLprim value test7(value ra, value rb) {
  ...
  caml_gc_minor(Val_unit);
  is_true(test, "before", caml_weak_array_get(weak, 0, NULL));
  caml_modify(&Field(eph, 0), caml_ephemeron_create(1));
  caml_modify(&Field(rc, 0), Val_unit);
  caml_gc_full_major(Val_unit);
  caml_gc_full_major(Val_unit);
  caml_gc_full_major(Val_unit);
  is_false(test, "after", caml_weak_array_get(weak, 0, NULL));
...
CAMLprim value test8(value ra, value rb) {
  ...
  is_false(test, "eph get empty null", caml_ephemeron_get_key(x, 5, NULL));
  is_false(test, "eph get empty nonull", caml_ephemeron_get_key(x, 5, &y));
  is_false(test, "eph get copy empty null ", caml_ephemeron_get_key_copy(x, 5, NULL));
  is_false(test, "eph get copy empty nonnull", caml_ephemeron_get_key_copy(x, 5, &y));
  caml_ephemeron_set_key(x, 5, ra);
  is_true(test, "eph get null", caml_ephemeron_get_key(x, 5, NULL));
  is_true(test, "eph get nonull", caml_ephemeron_get_key(x, 5, &y));
  is_true(test, "eph get eq", y == ra);
  is_true(test, "eph get copy null ", caml_ephemeron_get_key_copy(x, 5, NULL));
  ...
  is_false(test, "eph get unset null", caml_ephemeron_get_key(x, 5, NULL));
  is_false(test, "eph get unset nonull", caml_ephemeron_get_key(x, 5, &y));
  is_false(test, "eph get copy unset null ", caml_ephemeron_get_key_copy(x, 5, NULL));
  ...
  is_false(test, "eph get data empty null", caml_ephemeron_get_data(x, NULL));
  is_false(test, "eph get data empty nonull", caml_ephemeron_get_data(x, &y));
  is_false(test, "eph get data copy empty null ", caml_ephemeron_get_data_copy(x, NULL));
  is_false(test, "eph get data copy empty nonnull", caml_ephemeron_get_data_copy(x, &y));
  caml_ephemeron_set_data(x, ra);
  is_true(test, "eph get data null", caml_ephemeron_get_data(x, NULL));
  is_true(test, "eph get data nonull", caml_ephemeron_get_data(x, &y));
  is_true(test, "eph get data eq", y == ra);
  is_true(test, "eph get data copy null ", caml_ephemeron_get_data_copy(x, NULL));
  ...
  is_false(test, "eph get data unset null", caml_ephemeron_get_data(x, NULL));
  is_false(test, "eph get data unset nonull", caml_ephemeron_get_data(x, &y));
  is_false(test, "eph get data copy unset null ", caml_ephemeron_get_data_copy(x, NULL));
